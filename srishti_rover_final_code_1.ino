...
#define ENC_IN_LEFT1_A 22
#define ENC_IN_RIGHT1_A 24
#define ENC_IN_LEFT2_A 26
#define ENC_IN_RIGHT2_A 28
#define ENC_IN_LEFT3_A 30
#define ENC_IN_RIGHT3_A 32
// Other encoder output to Arduino to keep track of wheel direction
// Tracks the direction of rotation.
#define ENC_IN_LEFT1_B 23
#define ENC_IN_RIGHT1_B 25
#define ENC_IN_LEFT2_B 27
#define ENC_IN_RIGHT2_B 29
#define ENC_IN_LEFT3_B 31
#define ENC_IN_RIGHT3_B 33
...
const int pwm1 = 42;
const int dir1 = 43;
CytronMD motor1(PWM_DIR, 42, 43);  // PWM 1 = Pin 3, DIR 1 = Pin 4

// Motor B connections Right Motor
const int pwm2 = 44;
const int dir2 = 45;
CytronMD motor2(PWM_DIR, 44, 45);

// Motor C connections
const int pwm3 = 46;
const int dir3 = 47;
CytronMD motor3(PWM_DIR, 46, 47);

// Motor D connections
const int pwm4 = 48;
const int dir4 = 49;
CytronMD motor4(PWM_DIR, 48, 49);

// Motor E connections
const int pwm5 = 50;
const int dir5 = 51;
CytronMD motor5(PWM_DIR, 50, 51);

// Motor F connections
const int pwm6 = 52;
const int dir6 = 53;
CytronMD motor6(PWM_DIR, 52, 53);
...
const int PWM_MIN = 180; // about 0.1 m/s
...
void calc_pwm_values(const geometry_msgs::Twist& cmdVel) {
  ...
  if (cmdVel.angular.z != 0.0) {
    ...
    if (cmdVel.angular.z > 0.0) {
      ...
      motor1.setSpeed(-PWM_TURN);
      motor2.setSpeed(PWM_TURN);
      motor3.setSpeed(-PWM_TURN);
      motor4.setSpeed(PWM_TURN);
      motor5.setSpeed(-PWM_TURN);
      motor6.setSpeed(PWM_TURN);
  ...
  {pwmLeftReq = -PWM_BACKWARD;
      ...
      motor1.setSpeed(PWM_BACKWARD);
      motor2.setSpeed(PWM_BACKWARD);
      motor3.setSpeed(PWM_BACKWARD);
      motor4.setSpeed(PWM_BACKWARD);
      motor5.setSpeed(PWM_BACKWARD);
      motor6.setSpeed(PWM_BACKWARD);
      }
  // Go straight
  else {
